...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"PrettyGraphControls\", function() { return PrettyGraphControls; });\n/* harmony import */ var d3_selection__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! d3-selection */ \"../../node_modules/d3-selection/src/index.js\");\n/* harmony import */ var d3_zoom__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! d3-zoom */ \"../../node_modules/d3-zoom/src/index.js\");\n/* harmony import */ var three__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! three */ \"three\");\n/* harmony import */ var three__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(three__WEBPACK_IMPORTED_MODULE_2__);\nvar __extends = (undefined && undefined.__extends) || (function () {\n    var extendStatics = function (d, b) {\n        extendStatics = Object.setPrototypeOf ||\n            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||\n            function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };\n        return extendStatics(d, b);\n    };\n    return function (d, b) {\n        extendStatics(d, b);\n        function __() { this.constructor = d; }\n        d.prototype = b === null ? Object.create(b) : (__.prototype = b.prototype, new __());\n    };\n})();\n\n\n\nvar PrettyGraphControls = /** @class */ (function (_super) {\n    __extends(PrettyGraphControls, _super);\n    function PrettyGraphControls(camera, container) {\n        var _this = _super.call(this) || this;\n        _this.enabled = true;\n        _this.scale = 1.0;\n        _this._camera = camera;\n        _this._selection = Object(d3_selection__WEBPACK_IMPORTED_MODULE_0__[\"select\"])(container);\n        return _this;\n    }\n    PrettyGraphControls.prototype.init = function () {\n        var _this = this;\n        this._zoom = Object(d3_zoom__WEBPACK_IMPORTED_MODULE_1__[\"zoom\"])()\n            .filter(function () { return _this.enabled && !d3_selection__WEBPACK_IMPORTED_MODULE_0__[\"event\"].ctrlKey; })\n            .on('zoom', function () { return _this._zoomHandler(d3_selection__WEBPACK_IMPORTED_MODULE_0__[\"event\"].transform); });\n        this._selection\n            .on('contextmenu', this._onContextMenu.bind(this))\n            .on('mousedown', this._onMouseDown.bind(this))\n            .on('mousemove', this._onMouseMove.bind(this))\n            .on('mouseup', this._onMouseUp.bind(this))\n            .on('dblclick', this._onDblClick.bind(this))\n            .on('click', this._onClick.bind(this))\n            .call(this._zoom)\n            .on('wheel', this._onRotate.bind(this))\n            .on('dblclick.zoom', null);\n        this._onResize = function () {\n            _this._zoomHandler(Object(d3_zoom__WEBPACK_IMPORTED_MODULE_1__[\"zoomTransform\"])(_this._selection.node()));\n        };\n        window.addEventListener('resize', this._onResize, false);\n    };\n    PrettyGraphControls.prototype.setZoomExtent = function () {\n        var start = this._camera.near + 1;\n        var end = this._camera.far - 1;\n        this._zoom.scaleExtent([this._getScaleFromZ(end), this._getScaleFromZ(start)]);\n        if (this._camera.position.z > end) {\n            this.setCameraPosition(end);\n        }\n    };\n    PrettyGraphControls.prototype.setCameraPosition = function (z) {\n        // Set camera position\n        this._camera.position.set(0, 0, z);\n        this._camera.lookAt(0, 0, 0);\n        this.scale = this._getScaleFromZ(z);\n        var dimensions = this._selection.node().getBoundingClientRect();\n        var initialTransform = d3_zoom__WEBPACK_IMPORTED_MODULE_1__[\"zoomIdentity\"].translate(dimensions.width / 2, dimensions.height / 2).scale(this.scale);\n        this._zoom.transform(this._selection, initialTransform);\n    };\n    PrettyGraphControls.prototype.setTransform = function (position) {\n        var dimensions = this._selection.node().getBoundingClientRect();\n        var x = dimensions.width / 2 - this.scale * position.x;\n        var y = this.scale * position.y + dimensions.height / 2;\n        var initialTransform = d3_zoom__WEBPACK_IMPORTED_MODULE_1__[\"zoomIdentity\"].translate(x, y).scale(this.scale);\n        this._zoom.transform(this._selection, initialTransform);\n    };\n    PrettyGraphControls.prototype.dispose = function () {\n        window.removeEventListener('resize', this._onResize);\n        this._selection\n            .on('contextmenu', null)\n            .on('mousedown', null)\n            .on('mousemove', null)\n            .on('mouseup', null)\n            .on('dblclick', null)\n            .on('click', null)\n            .on('wheel', null)\n            .on('.zoom', null);\n    };\n    PrettyGraphControls.prototype._onRotate = function () {\n        // this.dispatchEvent({\n        //   type: 'rotate'\n        // });\n    };\n    PrettyGraphControls.prototype._onContextMenu = function () {\n        d3_selection__WEBPACK_IMPORTED_MODULE_0__[\"event\"].preventDefault();\n        d3_selection__WEBPACK_IMPORTED_MODULE_0__[\"event\"].stopPropagation();\n        var _a = Object(d3_selection__WEBPACK_IMPORTED_MODULE_0__[\"mouse\"])(this._selection.node()), mouseX = _a[0], mouseY = _a[1];\n        this.dispatchEvent({\n            position: {\n                x: mouseX,\n                y: mouseY\n            },\n            type: 'contextmenu'\n        });\n    };\n    PrettyGraphControls.prototype._onMouseMove = function () {\n        var _a = Object(d3_selection__WEBPACK_IMPORTED_MODULE_0__[\"mouse\"])(this._selection.node()), mouseX = _a[0], mouseY = _a[1];\n        this.dispatchEvent({\n            position: {\n                x: mouseX,\n                y: mouseY\n            },\n            type: 'mousemove'\n        });\n    };\n    PrettyGraphControls.prototype._onMouseDown = function () {\n        var _a = Object(d3_selection__WEBPACK_IMPORTED_MODULE_0__[\"mouse\"])(this._selection.node()), mouseX = _a[0], mouseY = _a[1];\n        this.dispatchEvent({\n            event: d3_selection__WEBPACK_IMPORTED_MODULE_0__[\"event\"],\n            position: {\n                x: mouseX,\n                y: mouseY\n            },\n            type: 'mousedown'\n        });\n    };\n    PrettyGraphControls.prototype._onDblClick = function () {\n        var _a = Object(d3_selection__WEBPACK_IMPORTED_MODULE_0__[\"mouse\"])(this._selection.node()), mouseX = _a[0], mouseY = _a[1];\n        this.dispatchEvent({\n            position: {\n                x: mouseX,\n                y: mouseY\n            },\n            type: 'dblclick'\n        });\n    };\n    PrettyGraphControls.prototype._onClick = function () {\n        var _a = Object(d3_selection__WEBPACK_IMPORTED_MODULE_0__[\"mouse\"])(this._selection.node()), mouseX = _a[0], mouseY = _a[1];\n        this.dispatchEvent({\n            position: {\n                x: mouseX,\n                y: mouseY\n            },\n            type: 'click'\n        });\n    };\n    PrettyGraphControls.prototype._onMouseUp = function () {\n        this.dispatchEvent({ type: 'mouseup' });\n    };\n    PrettyGraphControls.prototype._zoomHandler = function (transform) {\n        if (!this.enabled) {\n            return;\n        }\n        var dimensions = this._selection.node().getBoundingClientRect();\n        if (transform.k !== this.scale) {\n            if (!d3_selection__WEBPACK_IMPORTED_MODULE_0__[\"event\"].sourceEvent.ctrlKey) {\n                this.scale = transform.k;\n                var x = -(transform.x - dimensions.width / 2) / this.scale;\n                var y = (transform.y - dimensions.height / 2) / this.scale;\n                var z = this._getZFromScale(this.scale);\n                this._camera.position.set(x, y, z);\n                this.dispatchEvent({\n                    scale: transform.k,\n                    type: 'scale'\n                });\n            }\n            else {\n                this.dispatchEvent({\n                    delta: d3_selection__WEBPACK_IMPORTED_MODULE_0__[\"event\"].sourceEvent.deltaY,\n                    type: 'rotate'\n                });\n            }\n        }\n        else {\n            var x = -(transform.x - dimensions.width / 2) / this.scale;\n            var y = (transform.y - dimensions.height / 2) / this.scale;\n            var z = this._getZFromScale(this.scale);\n            this._camera.position.set(x, y, z);\n            this.dispatchEvent({\n                scale: this.scale,\n                type: 'pan'\n            });\n        }\n    };\n    PrettyGraphControls.prototype._getScaleFromZ = function (z) {\n        var dimensions = this._selection.node().getBoundingClientRect();\n        var halfFov = this._camera.fov / 2;\n        var halfFovRadians = this._toRadians(halfFov);\n        var halfFovHeight = Math.tan(halfFovRadians) * z;\n        var fovHeight = halfFovHeight * 2;\n        return dimensions.height / fovHeight;\n    };\n    PrettyGraphControls.prototype._getZFromScale = function (scale) {\n        var dimensions = this._selection.node().getBoundingClientRect();\n        var halfFov = this._camera.fov / 2;\n        var halfFovRadians = this._toRadians(halfFov);\n        var scaleHeight = dimensions.height / scale;\n        return scaleHeight / (2 * Math.tan(halfFovRadians));\n    };\n    PrettyGraphControls.prototype._toRadians = function (angle) {\n        return angle * (Math.PI / 180);\n    };\n    return PrettyGraphControls;\n}(three__WEBPACK_IMPORTED_MODULE_2__[\"EventDispatcher\"]));\n\n//# sourceMappingURL=data:application/json;base64,\n\n//# sourceURL=webpack://prettyGraphControls/./src/lib/controls.ts?");
